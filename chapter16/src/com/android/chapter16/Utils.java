...
public final class Utils
{
	...
	public static void setSphereEnvTexCoords(GlVertex vEye, GlMatrix mInvRot, FloatBuffer vertexBuffer, int vertexOffset, FloatBuffer normalBuffer,
		int normalOffset, FloatBuffer texCoordBuffer, int texCoordOffset)
	{
